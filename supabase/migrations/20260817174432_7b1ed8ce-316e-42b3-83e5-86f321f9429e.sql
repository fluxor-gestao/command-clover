-- Migration 20260817175500: Ajuste de Métricas Dashboard
...
BEGIN
    ...
    totals AS (
        SELECT
            ...
            COALESCE(SUM(invested_capital), 0) as invested_capital,
            ...
            COALESCE(SUM(overdue_amount + future_amount), 0) as total_to_receive,
            COALESCE(SUM(overdue_amount), 0) as overdue_amount,
            COALESCE(SUM(future_amount), 0) as future_amount,
            COALESCE(GREATEST(SUM(total_received) - SUM(invested_capital), 0), 0) as profit_amount,
